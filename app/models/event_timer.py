...
class EventTimer(db.Model):
    ...
    final_round = db.Column(db.Integer, nullable=False, default=1)
    round_duration = db.Column(
        db.Integer, nullable=False, default=180
    )  # Duration in seconds
    ...
    pause_time_remaining = db.Column(
        db.Integer, nullable=True
    )  # Seconds remaining when paused
    break_duration = db.Column(
