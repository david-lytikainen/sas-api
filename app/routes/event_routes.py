...
def update_event_status(event_id):
    ...
    try:
        ...
        current_user = User.query.options(db.joinedload(User.role)).filter_by(id=current_user_id).first()
        ...
        is_admin = current_user.role.permission_level >= UserRole.ADMIN.value
        is_event_creator = current_user.role.permission_level >= UserRole.ORGANIZER.value and str(event.creator_id) == str(current_user_id)
