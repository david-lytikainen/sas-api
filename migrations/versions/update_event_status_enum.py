...
def downgrade():
    ...
    op.execute("ALTER TABLE events ALTER COLUMN status TYPE eventstatus USING CASE WHEN status::text = 'Paused' THEN 'Cancelled'::eventstatus ELSE status::text::eventstatus END")
